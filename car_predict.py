...
def indata():
    ...
    with open (filename,'w',newline='') as f:
        ...
        w.writerow(data)        #사용저 입력 데이터를 파일에 작성
...
def model(filename):
    ...
    # 원핫인코딩 후에 훈련데이터와 테스트데이터 열(칼럼) 체크
    # 훈련 데이터 목록
    ...
    st.write('RForest:', root_mean_squared_error(y_val,X_predict))    #예측값
    ...
    #print(f'예상 가격은? {y_predict[0]}입니다')
